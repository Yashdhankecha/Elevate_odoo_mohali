    ...
    return (
        <div className="min-h-screen bg-gradient-mesh relative flex items-center justify-center p-4 overflow-hidden">
            ...
            <div className="max-w-md w-full relative z-10">
                {/* Header */}
                <div className="text-center mb-10 animate-fade-in text-slate-900">
                    <div className="inline-flex items-center justify-center p-3 bg-white rounded shadow-xl shadow-slate-100 mb-6 hover-lift">
                        <div className="w-12 h-12 bg-slate-900 rounded flex items-center justify-center text-white text-2xl font-bold">
                            E
                        </div>
                    </div>
                ...
                <div className="glass-card rounded-2xl p-8 md:p-10 animate-slide-up">
                    {errors.general && (
                        <div className="mb-6 p-4 bg-rose-50 border border-rose-100 rounded-xl animate-fade-in">
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2 px-1">
                                    ...
                                    <Link to="/forgot-password" title="Forgot Password" className="text-xs font-bold text-slate-900 hover:text-slate-700 transition-colors">
                                        Forgot Password?
                                    </Link>
                                </div>
                                <div className="relative group">
                    ...
                    <div className="mt-10 pt-8 border-t border-slate-200/50 text-center">
                        <p className="text-slate-500 font-medium">
                            New here?{' '}
                            <Link to="/signup" className="text-slate-900 font-bold hover:text-slate-700 transition-colors">
                                Create an account
                            </Link>
                        </p>
                    </div>
