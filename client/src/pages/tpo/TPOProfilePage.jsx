        ...
        <div className="min-h-screen bg-slate-50/50 flex flex-col lg:flex-row">
            ...
            <div className={`flex-1 transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-20' : 'lg:ml-72'} relative min-w-0`}>
                ...
                <main className="pt-8 px-4 sm:px-6 lg:px-8 pb-12 w-full max-w-[1600px] mx-auto">
                    ...
                    <div className="bg-white border border-slate-200 shadow-sm rounded p-6 sm:p-8 lg:p-10 mb-8 animate-fade-in relative overflow-hidden group">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10 w-full">
                            <div className="relative group/avatar shrink-0">
                                <div className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded overflow-hidden shadow-xl ring-4 ring-white transition-transform duration-500 group-hover/avatar:scale-105 bg-white">
                                    {user?.profilePicture ? (
                                        <img src={user.profilePicture} alt={user.name} className="w-full h-full object-cover" />
                                    ) : (
                                        <div className="w-full h-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center text-3xl font-bold text-white uppercase">
                                            {getUserInitials(user?.name)}
                                        </div>
                                    )}
                                </div>
                                <button className="absolute -bottom-2 -right-2 p-2.5 sm:p-3 bg-white rounded shadow-xl text-blue-600 hover:bg-slate-900 hover:text-white transition-all transform hover:scale-110 active:scale-95 border border-slate-100 z-10">
                            ...
                            <div className="text-center md:text-left flex-1 space-y-3 sm:space-y-4 min-w-0">
                                <div>
                                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 sm:gap-3 mb-1 sm:mb-2">
                                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tight truncate max-w-full">{getUserDisplayName(user)}</h1>
                                        <span className="px-3 py-1 bg-blue-100 text-blue-700 text-[10px] sm:text-xs font-black uppercase tracking-widest rounded shrink-0">TPO</span>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 lg:gap-8">
                            ...
                            {tabs.map((tab) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 rounded font-bold transition-all duration-300 shrink-0 ${isActive ? 'bg-slate-900 text-white shadow-lg xl:translate-x-1' : 'bg-white border border-slate-200 text-slate-500 hover:bg-slate-50'
                                            }`}
                                    >
                        ...
                        <div className="xl:col-span-3 min-w-0">
                            <div className="bg-white border border-gray-100 shadow-sm rounded-xl p-4 sm:p-6 lg:p-8 xl:p-10 animate-fade-in h-full overflow-hidden">
                                {activeTab === 'security' && (
                                    <div className="space-y-6 sm:space-y-8 animate-fade-in">
                                        <div className="flex items-center gap-3 text-slate-900">
                                            <div className="p-2 sm:p-3 bg-blue-50 rounded shrink-0">
                                        ...
                                        {user?.googleId ? (
                                            <div className="p-6 bg-slate-50 border-2 border-dashed border-slate-200 rounded-xl text-center">
                                                <div className="w-16 h-16 bg-white rounded flex items-center justify-center mx-auto mb-4 shadow-sm">
                                                ...
                                                <div className="space-y-3 sm:space-y-4">
                                                    <div className="space-y-1.5 sm:space-y-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-slate-50 border border-slate-200 rounded px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-slate-900 focus:border-slate-900" placeholder="Enter existing password"
                                                        />
                                                    </div>
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                                                        <div className="space-y-1.5 sm:space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full bg-slate-50 border border-slate-200 rounded px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-slate-900 focus:border-slate-900" placeholder="At least 6 chars"
                                                            />
                                                        </div>
                                                        <div className="space-y-1.5 sm:space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full bg-slate-50 border border-slate-200 rounded px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-slate-900 focus:border-slate-900" placeholder="Verify new password"
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="submit" disabled={loading} className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-slate-900 border border-slate-900 hover:bg-slate-800 text-white rounded shadow-sm flex items-center justify-center sm:justify-start gap-2 font-bold transition-all disabled:opacity-50 sm:ml-auto">
                                ...
                                {activeTab === 'danger' && (
                                    <div className="space-y-6 sm:space-y-8 animate-fade-in">
                                        <div className="flex items-center gap-3 text-rose-600">
                                            <div className="p-2 sm:p-3 bg-rose-50 rounded-lg shrink-0">
                                        ...
                                        <div className="p-5 sm:p-8 bg-rose-50 border border-rose-100 rounded-xl space-y-4 sm:space-y-6">
                                                ...
                                                {!user?.googleId && (
                                                    <div className="space-y-1.5 sm:space-y-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-white border-2 border-rose-100 rounded px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base focus:outline-none focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all text-rose-900 font-bold placeholder:text-rose-200"
                                                            placeholder="Type your password to verify"
                                                        />
                                                    </div>
                                                )}
                                                <button type="submit" disabled={loading} className="w-full bg-rose-600 text-white font-black py-3 sm:py-4 rounded shadow-xl shadow-rose-200 hover:bg-rose-700 transition-all active:scale-[0.98] flex items-center justify-center gap-2 text-sm sm:text-base">
