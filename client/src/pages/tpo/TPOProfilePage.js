                    ...
                    <div className="bg-white border border-gray-100 shadow-sm rounded-3xl p-6 sm:p-8 lg:p-10 mb-8 animate-fade-in relative overflow-hidden group">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10 w-full">
                            <div className="relative group/avatar shrink-0">
                                ...
                                <button className="absolute -bottom-2 -right-2 p-2.5 sm:p-3 bg-white rounded-2xl shadow-xl text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all transform hover:scale-110 active:scale-95 border border-slate-100 z-10">
                            ...
                            <div className="text-center md:text-left flex-1 space-y-3 sm:space-y-4 min-w-0">
                                <div>
                                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 sm:gap-3 mb-1 sm:mb-2">
                                        ...
                                        <span className="px-3 py-1 bg-indigo-100 text-indigo-700 text-[10px] sm:text-xs font-black uppercase tracking-widest rounded-full shrink-0">TPO</span>
                                    </div>
                            ...
                            {tabs.map((tab) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold transition-all duration-300 shrink-0 ${isActive ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200 xl:translate-x-1' : 'bg-white border border-gray-100 text-slate-500 hover:bg-slate-50'
                                            }`}
                                    >
                                ...
                                {activeTab === 'security' && (
                                    <div className="space-y-6 sm:space-y-8 animate-fade-in">
                                        <div className="flex items-center gap-3 text-slate-900">
                                            <div className="p-2 sm:p-3 bg-indigo-50 rounded-xl sm:rounded-2xl shrink-0">
                                                ...
                                                <div className="space-y-3 sm:space-y-4">
                                                    <div className="space-y-1.5 sm:space-y-2">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400" placeholder="Enter existing password"
                                                        />
                                                    </div>
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                                                        <div className="space-y-1.5 sm:space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400" placeholder="At least 6 chars"
                                                            />
                                                        </div>
                                                        <div className="space-y-1.5 sm:space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400" placeholder="Verify new password"
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="submit" disabled={loading} className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-lg shadow-indigo-200 flex items-center justify-center sm:justify-start gap-2 font-bold transition-all disabled:opacity-50 sm:ml-auto">
