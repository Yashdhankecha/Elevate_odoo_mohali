            ...
            <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl mx-auto">
                        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-slate-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob"></div>
                        <div className="absolute top-20 left-0 w-[500px] h-[500px] bg-slate-50 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
                    </div>
                    {/* Grid Pattern */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-slate-100 border border-slate-200 text-slate-600 text-xs font-semibold uppercase tracking-wider mb-8 animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-300">
                        <Link
                            to="/signup"
                            className="w-full sm:w-auto px-8 py-4 bg-slate-900 text-white rounded font-semibold text-lg hover:bg-slate-800 transition-all hover:-translate-y-1 shadow-xl shadow-slate-200 flex items-center justify-center gap-2"
                        >
                            Get Started Free
                        ...
                        <Link
                            to="/login"
                            className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 border border-slate-200 rounded font-semibold text-lg hover:bg-slate-50 transition-all hover:border-slate-300 flex items-center justify-center"
                        >
                            View Demo
                        </Link>
                    </div>
                    ...
                    <div className="mt-20 relative max-w-5xl mx-auto animate-fade-in-up animation-delay-500">
                        <div className="relative rounded-xl border border-slate-200 bg-white/50 backdrop-blur-xl p-2 shadow-2xl shadow-slate-200">
                            <div className="absolute inset-x-0 -top-20 h-20 bg-gradient-to-b from-transparent to-white/20"></div>
                            <div className="rounded border border-slate-200 aspect-[16/9] relative overflow-hidden bg-slate-50">
                                {/* Abstract Dashboard UI Representation */}
                                <div className="absolute inset-0 flex">
                                    {/* Sidebar */}
                                    <div className="w-64 border-r border-slate-200 bg-white p-4 hidden md:block">
                                        <div className="h-8 w-8 bg-slate-900 rounded mb-8"></div>
                                        <div className="space-y-3">
                                            {[1, 2, 3, 4, 5].map(i => (
                                                <div key={i} className="h-8 w-full bg-slate-100 rounded"></div>
                                            ))}
                                        </div>
                                    </div>
                                    {/* Main Content */}
                                    <div className="flex-1 bg-slate-50 p-6">
                                        <div className="flex justify-between items-center mb-6">
                                            <div className="h-8 w-32 bg-white rounded border border-slate-200"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">
                            ...
                            <span className="text-slate-900">manage placements</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Feature 1 - Large */}
                        <div className="md:col-span-2 bg-slate-50 border border-slate-200 rounded p-8 lg:p-10 hover:border-slate-300 transition-colors group relative overflow-hidden">
                            <div className="relative z-10">
                                <div className="w-12 h-12 bg-white border border-slate-200 rounded flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform">
                            ...
                            <div className="absolute right-0 bottom-0 w-1/2 h-full opacity-10 bg-[radial-gradient(#0f172a_1px,transparent_1px)] [background-size:16px_16px]"></div>
                        </div>

                        {/* Feature 2 */}
                        <div className="bg-slate-900 text-white rounded p-8 lg:p-10 flex flex-col justify-between group">
                            <div>
                                <div className="w-12 h-12 bg-white/10 rounded flex items-center justify-center mb-6 backdrop-blur-sm">
                        ...
                        {/* Feature 3 */}
                        <div className="bg-white border border-slate-200 rounded p-8 lg:p-10 hover:shadow-xl hover:shadow-slate-100 transition-all group">
                            <div className="w-12 h-12 bg-slate-50 rounded flex items-center justify-center mb-6">
                        ...
                        {/* Feature 5 */}
                        <div className="bg-slate-900 text-white rounded p-8 lg:p-10 hover:shadow-xl hover:shadow-slate-500/20 transition-all group">
                            <div className="w-12 h-12 bg-white/20 rounded flex items-center justify-center mb-6 backdrop-blur-md">
                                <Globe className="w-6 h-6 text-white" />
                            </div>
                            <h3 className="text-xl font-bold mb-3">Campus Wide Network</h3>
                            <p className="text-slate-300">Connect seamlessly across departments and campuses for unified placement drives.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="py-24 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link to="/signup" className="px-8 py-4 bg-slate-900 text-white rounded font-bold text-lg hover:bg-slate-800 transition-all hover:-translate-y-1 shadow-lg shadow-slate-200">
                            Get Started Now
                        </Link>
                        <Link to="/contact" className="px-8 py-4 bg-white text-slate-700 border border-slate-200 rounded font-bold text-lg hover:bg-slate-50 transition-colors">
                            Contact Sales
                        </Link>
                    </div>
                </div>
